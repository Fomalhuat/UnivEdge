...
| `benchmarks.md`（待建） | 基准结果库：文献基准值、已知特解、可复现判据 | VERIFICATION NC-01/NC-06 的参照来源 |
| `claims.md`（待建） | 主张注册表：agent 产出的主张及其状态（claimed/verified/rejected） | METHODOLOGY §0.3 状态机 |
